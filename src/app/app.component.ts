 ...
 * @Author: JackChouMine
 * @LastEditTime: 2020-12-28 02:24:43 +0800
 * @LastEditors: JackChou
 */
import {
	Component, ViewEncapsulation, OnChanges, SimpleChanges, OnInit, DoCheck,
...
export class AppComponent implements OnChanges, OnInit, DoCheck, AfterContentInit,
	...
	constructor() {
		...
		console.warn('父组件 类初始化')
	}
	ngOnChanges(changes: SimpleChanges): void {
		console.warn('父组件 ngOnChanges')
		console.log('参数', changes)
	}
	ngOnInit(): void {
		console.warn('父组件 ngOnInit')
		this.title = '这是来自父组件的数据'
	}
	ngDoCheck(): void {
		console.warn('父组件 ngDoCheck')
		this.title = '这是来自父组件的数据'
	}
	ngAfterViewInit(): void {
		console.warn('父组件 ngAfterViewInit')
	}
	ngAfterViewChecked(): void {
		console.warn('父组件 ngAfterViewChecked')
	}
	ngAfterContentInit(): void {
		console.warn('父组件 ngAfterContentInit')
	}
	ngAfterContentChecked(): void {
		console.warn('父组件 ngAfterContentChecked')
	}
	ngOnDestroy(): void {
		console.warn('父组件 ngDoDestroy')
	}
